...
-- AddForeignKey
ALTER TABLE "teachersDisciplines" ADD CONSTRAINT "teachersDisciplines_disciplneId_fkey" FOREIGN KEY ("disciplneId") REFERENCES "disciplines"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
